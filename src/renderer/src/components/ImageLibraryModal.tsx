    ...
    >
      <div className="flex max-h-[80vh] w-[500px] flex-col rounded-lg bg-background shadow-lg">
        <div className="flex items-center justify-between border-b px-4 py-3">
          <h3 className="text-sm font-semibold">{t('imageLibrary.title')}</h3>
        ...
        <div className="border-b px-4 py-2">
          <input
            type="text"
            placeholder={t('imageLibrary.search')}
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {filtered.length === 0 ? (
            <p className="text-center text-sm text-muted-foreground">{t('imageLibrary.noImages')}</p>
          ) : (
